...
const ClearBtn: React.FC<Props> = ({action, onClick, type}: Props) => {

    return (
        <Button className={ type === 'small' ? 'btn__small' : '' } action={ action } onClick={ onClick }>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                 viewBox="0 0 511.995 511.995" width="1.5rem" height="1.5rem">
                <g>
                    <g>
